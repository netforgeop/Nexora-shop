...
<section id="comments" class="comments-area" aria-labelledby="comments-title">
	...
	comment_form(
		array(
			...
			'fields'               => array(
				'author' => '<div class="form-cols"><div class="form-group"><label class="form-label" for="author">' . esc_html__( 'Name', 'nexora' ) . ( $nexora_req ? ' <span class="req">*</span>' : '' ) . '</label><input id="author" class="form-control" name="author" type="text" value="' . esc_attr( $nexora_commenter['comment_author'] ) . '" minlength="2"' . $nexora_aria . '></div>',
